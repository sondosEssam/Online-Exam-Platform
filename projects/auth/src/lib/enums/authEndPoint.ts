export class AuthEndPoint {
    ...
    static readonly RESET_CODE = 'https://exam.elevateegy.com/api/v1/auth/verifyResetCode';
    static readonly CHANGE_PASSWORD = 'https://exam.elevateegy.com/api/v1/auth/changePassword';
    static readonly DELETEMYACCOUNT = 'https://exam.elevateegy.com/api/v1/auth/deleteMe';
